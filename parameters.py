...
OBJECT_SIZE_LIGHT: int = 120 #70 # 120 #-------------------------!!!! 70
...
ARENA_LAYOUT_FOLDER:str = "simulation_objects/big_arena/" #"simulation_objects/arena_layouts/" #"simulation_objects/big_arena/" #"simulation_objects/arena_layouts_cl/"
ARENA_LAYOUT_NAME:str = "arena_layout1_big_ob" #"arena_layout2" #"arena_layout1_big_ob"

if ARENA_LAYOUT_NAME == "arena_layout2":
    ARENA_LAYOUT_NAMES = ["arena_layout2", "arena_layout3", "arena_layout4", "arena_layout5", "arena_layout6"]
else:
    ARENA_LAYOUT_NAMES = ["arena_layout1_big_ob", "arena_layout2_big_ob", "arena_layout3_big_ob", "arena_layout4_big_ob", "arena_layout5_big_ob"]
...
DRAW_SIMULATION:bool = False # ------------------
UPDATE_RATE:float = 1./4000  # ------------------
REAL_FPS:float = 60.
...
APPROACH_NAME:str = "approach5"  # <---------------------------------------------
APPROACH_NUMBER:int = int(APPROACH_NAME[8])
COMMENT:str = "bugfix_swarm5_term04_shareEnergie"   # ---------------------------------
#COMMENT:str = "_TEST_" # ------------------------
...
QUADRATIC_FUNCTION:bool = False  # additonal option for approach 2

DYNAMIC_ENVIRONMENT = False  # ----------------------------- set true if combine approach 4 with approach 5 or 2
if APPROACH_NUMBER == 4:
    DYNAMIC_ENVIRONMENT = True

BATTERY_PENALTY:bool = False  # additonal option for approach 5
TERMINATION_IN_RISK:bool = True  # additonal option for approach 5
...
# Evo Termination
TERMINATION_PARA_FITNESS = 0.9999 #TODO
...
# For approach 5
prob_to_terminate = 0.4      # termination probability if robot stays whole time in risk zone
TERMINATION_PROB_IN_RISK = prob_to_terminate / float(MAX_TIME_STEPS_REACHED)

BATTERY_CHARGE_PER_TS:float = 0.01 # 0.01
BATTERY_TS_LENGTH:int = 2000 #2000 # -------------------------!!!!
