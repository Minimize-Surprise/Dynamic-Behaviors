...
OBJECT_SIZE_LIGHT: int = 70 #100 #70 #70 # 120 #-------------------------!!!! 70
...
ARENA_LAYOUT_FOLDER:str = "simulation_objects/arena_layouts_cl/" #"simulation_objects/arena_layouts/" #"simulation_objects/big_arena/"
...
APPROACH_NAME:str = "approach5-4-2"  # <-----------
APPROACH_NUMBER:int = int(APPROACH_NAME[8])
COMMENT:str = "_adaptFit_termBat04_changeLight"
#COMMENT:str = "_TEST_" # ------------------------
...
DYNAMIC_ENVIRONMENT = True  # ----------------------------- set true if combine approach 4 with approach 5 or 2
