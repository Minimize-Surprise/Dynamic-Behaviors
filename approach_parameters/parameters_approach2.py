...
OBJECT_SIZE_LIGHT: int = 70 #70 # 120 #-------------------------!!!! 70
...
ARENA_LAYOUT_FOLDER:str = "simulation_objects/arena_layouts/" #"simulation_objects/arena_layouts/" #"simulation_objects/big_arena/" #"simulation_objects/arena_layouts_cl/"
ARENA_LAYOUT_NAME:str = "arena_layout2" #"arena_layout2" #"arena_layout1_big_ob"
...
APPROACH_NAME:str = "approach2-4"  # <-----------
APPROACH_NUMBER:int = int(APPROACH_NAME[8])
COMMENT:str = "_aptFit_final"
#COMMENT:str = "_TEST_" # ------------------------
...
# for approach 2
ADAPT_FITNESS_FUNCTION:bool = True    # set True to test approach 2  # ---------------------
...
# For approach 5
prob_to_terminate = 0.2      # termination probability if robot stays whole time in risk zone
